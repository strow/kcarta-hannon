function xcalcifp(idef)

% function xcalcifp(idef)
% "x" experimental version of calcifp with increased npts
% 
...
npts   = 2^21;	% for an npts+1 cosine transform (via a 2*npts fft)
%vlaser = 15799;	% HeNe laser frequency
vlaser = 15780;	% HeNe laser frequency
...
% kcarta parameters
%
dvk = 0.0025;		% kcarta point spacing
