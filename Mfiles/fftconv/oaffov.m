...
%  function [oafreq,oasrf] = oaffov(fchan,fmin,fmax,df,opd,thetac,hfov,nslice);
%
%  Compute an interfermeters spectral space SRF.  This routine handles
...
% Created: Scott Hannon, November? 1998
% Update: 22 Feb 1999 S.Hannon - fixed serious error in integration step
%    size and limits.
% Update: 15 Aug 2008, S.Hannon - add error trap for theta_i (tiny error
%    accumulates due to incremental addition of nslices of dtheta).
